...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:B7k6N+JlLM/u1xrIkpifUfE7GRJsZIYHoHbiAa5cSP4=",
        version = "v0.0.0-20200330101823-46266ca37bd3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_rmrobinson_bottlerocket_go",
        importpath = "github.com/rmrobinson/bottlerocket-go",
        patches = ["//third_party:com_github_rmrobinson_bottlerocket_go.patch"],  # keep
        sum = "h1:6Ol88m8O7FXNCCRvk3xOS1IzmBxGcs7o77hfgIa0o34=",
        version = "v1.0.0",
    )
    go_repository(
        name = "com_github_rmrobinson_hue_go",
        importpath = "github.com/rmrobinson/hue-go",
        sum = "h1:f1TNwaOp7GX0mmYf9aSNluDDif9h1BvWBtVz1J+cjTs=",
        version = "v0.0.0-20180806152530-008c4367e329",
    )
    go_repository(
        name = "com_github_rmrobinson_monoprice_amp_go",
        importpath = "github.com/rmrobinson/monoprice-amp-go",
    ...
    go_repository(
        ...
        sum = "h1:I7Vuu5Ejagca+VcgfBINHke3xwjCTYnIG4Q57fv0wYY=",
        version = "v0.0.0-20200409111301-baae70f3302d",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:mQTN3ECqfsViCNBgq+A40vdwhkGykrrQlYe3mPj6BoU=",
        version = "v0.0.0-20200409092240-59c9f1ba88fa",
    )
    go_repository(
