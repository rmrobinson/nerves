...
func (b *Hue) Bridge(ctx context.Context) (*Bridge, error) {
	...
	ret := &Bridge{
		...
		State: &BridgeState{
			Zigbee: &BridgeState_Zigbee{
				Channel: config.ZigbeeChannel,
			},
			Version: &BridgeState_Version{
				Sw:  config.SwVersion,
...
func (b *Hue) SetBridgeConfig(ctx context.Context, config *BridgeConfig) error {
...
func (b *Hue) SetBridgeState(ctx context.Context, state *BridgeState) error {
...
func (b *Hue) AvailableDevices(ctx context.Context) ([]*Device, error) {
...
func (b *Hue) Devices(ctx context.Context) ([]*Device, error) {
...
func (b *Hue) Device(ctx context.Context, id string) (*Device, error) {
...
func (b *Hue) SetDeviceConfig(ctx context.Context, dev *Device, config *DeviceConfig) error {
...
func (b *Hue) SetDeviceState(ctx context.Context, dev *Device, state *DeviceState) error {
	if strings.Contains(dev.Address, lightAddrPrefix) {
		id := addrToLight(dev.Address)
